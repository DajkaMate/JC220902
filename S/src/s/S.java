...
public class S {
    ...
    public static void main(String[] args) {
        ...
        //Részsztring: substring metódus (tól, ig, az ig. karakter már nem lesz benne)
        ...
        System.out.println(sb2.length()+ " " + sb1.capacity());
        String varos = "Sopron";
        StringBuffer sb3= new StringBuffer(s);
        System.out.println(sb3.length()+ " " + sb1.capacity());
        //A kiinduló sztring ezekkel a metódusokkal sem változik meg!
